---
title: Academic & Technical Resources
linkTitle: Courses
summary: "Hub for my university coursework and technical guides."
type: docs
...
{{< cards >}}
  ...
  {{< card url="microsoft-courses" title="💻 Microsoft Courses" icon="computer-desktop" subtitle="View course details and content" >}}
  {{< card url="certifications" title="🏅 Certifications" icon="check-badge" subtitle="RG146 and other professional certifications" >}}
{{< /cards >}}
...
Below is a snapshot of my **High Distinction (HD)** results from the Australian National University. For the full list of subjects, click the **"University Courses"** card above.
